...
public class AppHelper {
    ...
    private static boolean userTypeChanged = false;
    private static String userPoolAlias = "Student";
    ...
    public static void setUserPoolId(String userPoolId) {
        AppHelper.userPoolId = userPoolId;
    }

    private static String userPoolId = "";
    private static String clientId = "";
    private static String clientSecret = "";
    private static final String userPoolIdStudents = "";
    private static final String clientIdStudents = "";
    private static final String clientSecretStudents = "";
    private static final String userPoolIdTeachers = "";
    private static final String clientIdTeachers = "";
    private static final String clientSecretTeachers = "";
    private static final String userPoolIdAdmin = "";
    private static final String clientIdAdmin = "";
    private static final String clientSecretAdmin = "";
    ...
    public static void init(Context context) {
        ...
        if (userPool == null) {
            ...
            */
            ...
            userPool = null;
            userPool = new CognitoUserPool(context, userPoolId, clientId, clientSecret, cognitoRegion);
            Log.d(TAG, "UserPool Changed "+userPoolAlias);
        }
    ...
    public static void setUserPoolAttributes(String userType){

        Log.d(TAG, "UserPool "+userType);
        if(userType.toLowerCase().equals("student")){
            userPoolAlias = "Student";
            userPoolId = userPoolIdStudents;
            clientId = clientIdStudents;
            clientSecret = clientSecretStudents;
        }
        else if(userType.toLowerCase().equals("teacher")){
            userPoolAlias = "Teacher";
            userPoolId = userPoolIdTeachers;
            clientId = clientIdTeachers;
            clientSecret = clientSecretTeachers;
        }
        else{
            userPoolAlias = "Admin";
            userPoolId = userPoolIdAdmin;
    ...
    private static void setData() {
        ...
        signUpFieldsC2O.put("First Name","name");
        ...
        signUpFieldsC2O.put("Birth Date", "birthdate");
        ...
        signUpFieldsO2C.put("name", "First Name");
        signUpFieldsO2C.put("birthdate", "Birth Date");
